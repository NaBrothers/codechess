...
public class JettyServer {
    ...
    private static final String DEFAULT_WEBAPP_PATH = "codechess-core/src/main/webapp";

    private static final String WEB_XML_PATH = "codechess-code/src/main/webapp/WEB-INF/web.xml";
